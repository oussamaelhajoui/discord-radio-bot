...
const RadioCommand = function (message: Discord.Message, args: string[], voiceChannelState: Boolean) {
    ...
    voiceChannel.join()
        .then(connection => {
            ...
            if (message != null) message.channel.send(`:notes: Now playing ${args[0]}.`);
